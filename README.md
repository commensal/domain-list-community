...
Нажмите на ссылку ниже **с телефона** — откроется файл с deeplink, который автоматически передаст готовый профиль маршрутизации в ваше приложение.

| Клиент | Добавить полный профиль | Просмотр deeplink |
| :--- | :--- | :--- |
| 🟢 **Happ** (iOS / Android) | [📲 **Установить в Happ**](https://raw.githubusercontent.com/commensal/domain-list-community/refs/heads/master/HAPP/DEFAULT.DEEPLINK) | [Просмотр](https://github.com/commensal/domain-list-community/blob/master/HAPP/DEFAULT.DEEPLINK) |
| 🔵 **Incy** (iOS / Android) | [📲 **Установить в Incy**](https://raw.githubusercontent.com/commensal/domain-list-community/refs/heads/master/INCY/DEFAULT.DEEPLINK) | [Просмотр](https://github.com/commensal/domain-list-community/blob/master/INCY/DEFAULT.DEEPLINK) |

> 💡 **Как это работает?** При нажатии на ссылку браузер открывает файл, содержащий deeplink `happ://routing/add/...` или `incy://routing/add/...`. Мобильная ОС перехватывает протокол и передает конфигурацию в приложение.
